...
void motion_black_checkers(char* white_checkers, char* black_checkers, int size, char size_pole[][8], int check, char empty, int* ptr_number_white)            // проверка хода чЄрных шашек
{
    bool white{ true };
